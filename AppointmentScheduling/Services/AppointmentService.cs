...
namespace AppointmentScheduling.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<int> AddUpdate(AppointmentVM model)
        {
            ...
            {
                //update
                var appointment = _db.Appointments.SingleOrDefault(x => x.Id == model.Id);
            ...
            else
            {
                ...
                await _emailSender.SendEmailAsync(doctor.Email, "Appontment Created", $"Your appointment with {patient.Name} is created and in pending status");
                await _emailSender.SendEmailAsync(patient.Email, "Appontment Created", $"Your appointment with {doctor.Name} is created and in pending status");

                _db.Appointments.Add(appointment);
                await _db.SaveChangesAsync();

                return 2; //za create 2, za update 1
            }
        }
