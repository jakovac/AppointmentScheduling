...
namespace AppointmentScheduling.Controllers.Api
{
    ...
    [ApiController] //ovo je api endpoint
    public class AppointmentApiController : Controller
    {
        ...
        public AppointmentApiController(IAppointmentService appointmentService, IHttpContextAccessor httpContextAccessor)
        {
            ...
            loginUserId = _httpContextAccessor.HttpContext.User.FindFirstValue(ClaimTypes.NameIdentifier); //do login user id mozemo preko http context accessora koji ima objekat httpContext object koji ima generic user, moramo da ga registrujemo u Startup
            role = _httpContextAccessor.HttpContext.User.FindFirstValue(ClaimTypes.Role); //isto i sa rolom
        }
