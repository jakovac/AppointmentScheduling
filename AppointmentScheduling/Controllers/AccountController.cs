        ...
        public async Task<IActionResult> Login(LoginVM model)
        {
            if(ModelState.IsValid)
            {
                ...
                if(result.Succeeded)
                {
                    ...
                    HttpContext.Session.SetString("ssuserName", user.Name); //setovanje vrednosti u sesiji
                    //var userName = HttpContext.Session.GetString("ssuserName"); //uzimanje vrednosti iz sesije
